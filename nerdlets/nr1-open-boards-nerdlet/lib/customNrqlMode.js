...
export class CustomHighlightRules extends window.ace.acequire(
  ...
  constructor() {
    ...
    const keywords =
      'SELECT|FROM|SHOW EVENT TYPES|WHERE|AS|FACET|FACET CASES|LIMIT|SINCE|UNTIL|' +
      'WITH TIMEZONE|COMPARE WITH|TIMESERIES|EXTRAPOLATE|AUTO|MAX|AND';
